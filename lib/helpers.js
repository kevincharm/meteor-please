...
exports.initJson = function(cwd) {
  // Build JSON
  console.log("Configuring mplz.json settings file...".blue);
  ...
  prompt.get({ properties: {
    ...
    sshkey: {
      description: "Please specify the path to your SSH key",
      default: '~/.ssh/id_rsa'
    },
    setupmongo: {
    ...
    appdomain: {
      description: "What domain name will your app be served on? (Required for Nginx)",
